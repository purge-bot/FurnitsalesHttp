...
{
    public partial class CreateOrders_And_Products : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProduct", x => new { x.OrdersId, x.ProductsArticle });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_OrderProduct_Products_ProductsArticle",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProduct_ProductsArticle",
                table: "OrderProduct",
